/***************************************************************************
						  DInterface.h
 Interface class for exposing functions in DGisApp for use by plugins
							 -------------------
  begin                : 2004-02-11
...
/**
 * \class DInterface
 * \brief Interface class to provide access to private methods in DGisApp
 * for use by plugins.
 *
...
class DInterface : public QgisInterface
{
	Q_OBJECT
...
public:
	...
	/**
	 * Constructor.
	 * \param qgis Pointer to the DGisApp object
	 */
	DInterface(DGisApp *DGisApp);

	DInterface(DInterface const &) = delete;
	DInterface &operator=(DInterface const &) = delete;
