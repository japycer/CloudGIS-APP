...
{
  resultsDialog()->clear();
  //connect( this, &QgsMapToolIdentifyAction::identifyMessage, DGisApp::instance(), &DGisApp::showStatusMessage );//TODO
  ...
  //disconnect( this, &QgsMapToolIdentifyAction::identifyMessage, DGisApp::instance(), &DGisApp::showStatusMessage );

  if ( results.isEmpty() )
  {
    resultsDialog()->clear();
    //DGisApp::instance()->statusBarIface()->showMessage( tr( "No features at this position found." ) );
  }
  else
  {
