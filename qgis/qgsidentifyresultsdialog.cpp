  ...
  , mCanvas( canvas )
{
  ...
  mDock = new QgsDockWidget( tr( "Identify Results" ), DGisApp::instance() );
  mDock->setObjectName( QStringLiteral( "IdentifyResultsDock" ) );
  mDock->setAllowedAreas( Qt::LeftDockWidgetArea | Qt::RightDockWidgetArea );
  mDock->setWidget( this );
  if ( !DGisApp::instance()->restoreDockWidget( mDock ) )
    DGisApp::instance()->addDockWidget( Qt::RightDockWidgetArea, mDock );
  //else
    //DGisApp::instance()->panelMenu()->addAction( mDock->toggleViewAction() );
...
void QgsIdentifyResultsDialog::activateLayer()
{
  ...
  //         , DGisApp::instance(), &DGisApp::setActiveLayer );
...
void QgsIdentifyResultsDialog::layerProperties( QTreeWidgetItem *item )
{
  ...
  //DGisApp::instance()->showLayerProperties( vlayer );
}
